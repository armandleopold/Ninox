...
*/
$MONGO["servers"][$i]["mongo_name"] = getenv("MONGO_HOST");//mongo server name
...
$MONGO["servers"][$i]["mongo_port"] = getenv("MONGO_PORT");//mongo port
...
$MONGO["servers"][$i]["control_users"]["admin"] = getenv("MONGO_ADMIN_PASSWORD");;//one of control users ["USERNAME"]=PASSWORD, works only if mongo_auth=false
